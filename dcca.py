...
(X_train_1, Y_train_1), (X_val_1, Y_val_1), (X_test_1, Y_test_1) = load_data(
    "noisymnist_view1.gz",
    "https://www2.cs.uic.edu/~vnoroozi/noisy-mnist/noisymnist_view1.gz",
)
(X_train_2, Y_train_2), (X_val_2, Y_val_2), (X_test_2, Y_test_2) = load_data(
    "noisymnist_view2.gz",
...
projected_feats = dcca.train_dcca(
    data_view_1=data_view_1,
    data_view_2=data_view_2,
...
print(
    ...
    projected_feats[0][0].shape,
    projected_feats[1][0].shape,
    projected_feats[2][0].shape,
)
print(
    "Projected Text summary",
    projected_feats[0][1].shape,
    projected_feats[1][1].shape,
    projected_feats[2][1].shape,
)
